...
import HtmlCss from "../../public/assets/skills/html-css.svg";
...
const skillSet = [
  { id: 0, logo: HtmlCss, name: "HTML/CSS" },
              ...
              {skillSet.map((skill) => (
                <div key={skill.id} className="col-sm-12 col-md-6 col-lg-3 m-15px-tb">
                  <div className="feature-box-2 media align-items-center">
                    <div className="logo">
                      <Image src={skill.logo} width={64} height={64} alt={skill.name} />
                    </div>
